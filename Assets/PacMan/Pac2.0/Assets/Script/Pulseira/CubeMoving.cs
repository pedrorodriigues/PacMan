...
public class CubeMoving : MonoBehaviour {
	...
	void Update () {
		rawData = DebuggerAccelerometer.acelerometer;
	...
	//	Debug.Log("A"+rawData[0][0]);
	//	Debug.Log("B"+rawData[0][1]);
	//	Debug.Log("C"+rawData[0][2]);
	//	Debug.Log("D"+rawData[1][0]);
	//	Debug.Log("E"+rawData[1][1]);
	//	Debug.Log("F"+rawData[1][2]);
